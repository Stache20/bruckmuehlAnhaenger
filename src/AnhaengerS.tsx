...
import {Accordion, rem, ThemeIcon, List, Card, Text,Button, useMantineTheme } from '@mantine/core';
  ...
  return (
    ...
    <div style={{ width: 600, margin: 'auto' }}>
      <Card  shadow="sm" padding="lg">
        <Text align="center" size='xl' weight={700}>S Anhänger</Text>
        ...
        Zulässiges Gesamtgewicht: 0,75 t, ohne Bremse.
        </Text>
      ...
      py='xl'
    > 
      <List.Item>1 - 5  Std. - 23,- €</List.Item>
      <List.Item>6 - 24 Std. - 30,- €</List.Item>
      <List.Item>Wochenende  - 60,- €</List.Item>
      <List.Item>1 Woche     - 150,- €</List.Item>
</List>
<Accordion
